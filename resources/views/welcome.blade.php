...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="min-h-screen bg-white dark:bg-gray-900">
            ...
            @endif
            <div class="py-24 md:py-32 px-4 mx-auto max-w-screen-xl text-center lg:px-12">
                <h1 class="mb-4 font-extrabold tracking-tight leading-none text-gray-900 text-6xl dark:text-white">
                    Welcome
                </h1>
